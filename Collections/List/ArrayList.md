...
🔗 [노션 링크](https://www.notion.so/ArrayList-Class-4754c8fe9c3a44788efe5e3e69294b1a?source=copy_link)

ArrayList는 Java Collection Framework에서 가장 많이 사용되는 List 구현체로,  
내부적으로 배열을 사용하여 동적 크기 조절이 가능한 리스트이다.
